...
CFLAGS_040	= -c -mcpu=68040 -noixemul -Os -fomit-frame-pointer -std=c99 -std=c99 -DCPU_VERS=68040
CFLAGS_060	= -c -mcpu=68060 -noixemul -Os -fomit-frame-pointer -std=c99 -std=c99 -DCPU_VERS=68060
